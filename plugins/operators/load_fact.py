...
class LoadFactOperator(BaseOperator):
    ...
    """
    LoadFactOperator loads data into a fact table in Redshift from SQL commands.

    :param redshift_conn_id (str): Airflow connection ID for the Redshift database.
    :param table (str): Name of the fact table to load data into.
    :param sql_command (str): SQL command to extract data for the fact table.
